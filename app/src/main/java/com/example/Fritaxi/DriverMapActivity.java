...
public class DriverMapActivity extends FragmentActivity implements OnMapReadyCallback, RoutingListener {
   ...
   // GoogleApiClient mGoogleApiClient;
    ...
    private Button mLogout, mRideStatus, mSettings;
        ...
        mRideStatus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch(status){
                    case 1:
                        status=2;
                        // thelete the previous lines (for pick up)
                        erasePolylines();
                        // insert new lines
                        ...
                        break;
                    case 2:
                        // driver is on its way to the customer;
                        endRide();
                        break;
                }
            }
        ...
        assignedCustomerRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()&& customerId.equals("")) {
                    ...
                    //this is called every time a request is deleted
                    endRide();
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (map.get("destination") != null) {
                        ...
                        // the user called a taxi without a destination
